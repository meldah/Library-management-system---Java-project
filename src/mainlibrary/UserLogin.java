...
public class UserLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Вход за читатели");
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
        ...
        {
           this.dispose();
           UserSuccess.main(new String[]{User,Pass});
           
        }else{
				JOptionPane.showMessageDialog(UserLogin.this, "Грешно потребителско име или парола!","Грешка при вход!", JOptionPane.ERROR_MESSAGE);
				username.setText("");
				password.setText("");
        }
